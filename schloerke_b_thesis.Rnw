...
% TODO remove draft is true for final submission
% \usepackage{minted}
...
\chapter{R Package Descriptions}
...
\chapter{\rinline{ggduo}: Generalized Pairs Plot for Two Grouped Data}
...
\chapter{\autocogs: Metrics Enabling Detailed Interactive Data Visualization}
...
\chapter{\gqlr: An R server GraphQL implementation}
...
<< part_r_functions, child='parts/datasets.Rnw'>>=
@

<< part_r_functions, child='parts/r_functions.Rnw'>>=
@

% A vita is optional for masters theses
% and required for doctoral dissertations.
<< part_vita, child='parts/vita.Rnw'>>=
@
