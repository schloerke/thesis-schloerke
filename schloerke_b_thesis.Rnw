...
\newminted{c}{bgcolor=gqlbg, samepage=true}
\newmintinline{c}{bgcolor=gqlbg, samepage=true}
\newminted{r}{bgcolor=gqlbg, samepage=true}
\newmintinline{r}{bgcolor=gqlbg, samepage=true}
\newminted{graphql}{bgcolor=gqlbg, samepage=true}
\newmintinline{graphql}{bgcolor=gqlbg, samepage=true}
\newminted{js}{bgcolor=gqlbg, samepage=true}
...
\majorprofs{Dr. William Cleveland, Dr. Ryan Hafen, Dr. Bowei Xi, Dr. Vinayak Rao}
...
% @
<< sum2, child='parts/package_summaries.Rnw'>>=
@

<< sum2, child='parts/background-autocogs.Rnw'>>=
@
<< sum2, child='parts/autocogs.Rnw'>>=
@

<< sum2, child='parts/background-ggplot2.Rnw'>>=
@
<< sum2, child='parts/ggduo.Rnw'>>=
@

<< sum2, child='parts/graphql.Rnw'>>=
@
