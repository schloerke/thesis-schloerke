...
<< plyr_example, fig.width = 5, fig.height = 3.75, out.width = "4in", out.height = "3in" >>=
library(dplyr)
library(gapminder)
gapminder
# input a data.frame
...
<< gapminder_best_worst, fig.width = 8, fig.height = 4, out.width = "5in", out.height = "2.5in" >>=
gapminder %>%
...
@
<< gapminder_best_worst2, fig.width = 8, fig.height = 4, out.width = "5in", out.height = "2.5in" >>=
gapminder %>%
...
@
<< trelliscopejs, screenshot.opts = list(vwidth = 700, vheight = 525) >>=
gapminder %>%
  group_by(country, continent) %>%
  # condense the data
  tidyr::nest() %>%
...
gap_trellis %>% trelliscope("gapminder")
@
