...
<< add_custom_plot, fig.width = 5, fig.height = 3.75, out.width = "4in", out.height = "3in" >>=
# retrieve the second row, first column sub plot
#  of the tips plot matrix
pm[2,1]
@
<< add_custom_plot2, fig.width = 5, fig.height = 3.75, out.width = "4in", out.height = "3in" >>=
...
<< ggmatrix_scores, fig.width = 5, fig.height = 3.75, out.width = "4in", out.height = "3in" >>=
ggduo(
  australia_PISA2012,
  c("gender", "homework"),
...
<< ggduo_types, fig.width = 5, fig.height = 3.75, out.width = "4in", out.height = "3in" >>=
# default
ggduo(
  tips,
  c("size", "smoker", "day"),
...
@
<< ggduo_types2, fig.width = 5, fig.height = 3.75, out.width = "4in", out.height = "3in" >>=
...
<< user_defined, fig.width = 5, fig.height = 3.75, out.width = "4in", out.height = "3in" >>=
...
<< stats_ts, fig.width = 5, fig.height = 3.75, out.width = "4in", out.height = "3in" >>=
