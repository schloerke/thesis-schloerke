...
The third cognostic type covers counts of the data.  The
...
autocogs::auto_cog("univariate_counts", gap_max$lifeExp, clusters = TRUE)
@
...
\item \rinline{"pairwise_counts"}

<< cog_group_pairwise_counts >>=
autocogs::auto_cog("pairwise_counts", gap_max$lifeExp, clusters = TRUE)
@

\item \rinline{"grouped_counts"}
<< cog_group_grouped_counts >>=
autocogs::auto_cog("grouped_counts", gap_max$lifeExp, clusters = TRUE)
@
