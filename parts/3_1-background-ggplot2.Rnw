...
% TODO include?
Using multiple conditioning variables within facet grid in Figure~\ref{facet_grid_multi}, both Male and Female smokers during Sunday Dinner do not follow a positive linear trend.
